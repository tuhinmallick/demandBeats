...
def detect_delimiter(text: str, default: Optional[str] = None, whitelist: Optional[List[str]] = None,
    ...
    if not likely_candidates:
        if whitelist is None and sniffed_candidates:
            ...
            return detect_delimiter(text, whitelist=new_whitelist) or default
        return default
